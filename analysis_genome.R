...
for(chrom_1 in genome_list){
  ...
  exon <- getBM(attributes = c("ensembl_gene_id","external_gene_name",
                               ...
                               filter = "chromosome_name", 
                               values = chrom_1)
  exon_regions <- GRanges(seqnames = Rle(chrom),
  ...
  exon_extend_regions <- GRanges(seqnames = Rle(chrom),
  ...
  intron_from_exon_extend_regions <- GRanges(seqnames = Rle(chrom),
  ...
  intron_extend_regions <- GRanges(seqnames = Rle(chrom),
  ...
  exon_from_intron_extend_regions <- GRanges(seqnames = Rle(chrom),
  ...
  utr_5_extend_regions <- GRanges(seqnames = Rle(chrom),
  ...
  for(i in c(1:(length(utr_5_overlap_list)/2))){
    utr_5_overlap[nrow(utr_5_overlap)+1,] <- c(chrom, utr_5_overlap_list[i*2-1], utr_5_overlap_list[i*2])
  }
  ...
  utr_5_overlap_regions <- GRanges(seqnames = Rle(chrom),
  ...
  utr_3_extend_regions <- GRanges(seqnames = Rle(chrom),
  ...
  for(i in c(1:(length(utr_3_overlap_list)/2))){
    utr_3_overlap[nrow(utr_3_overlap)+1,] <- c(chrom, utr_3_overlap_list[i*2-1], utr_3_overlap_list[i*2])
  }
  ...
  utr_3_overlap_regions <- GRanges(seqnames = Rle(chrom),
